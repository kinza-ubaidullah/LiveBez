...
export default function LoginModal({ isOpen, onClose, onSwitchToRegister }: LoginModalProps) {
    ...
    return (
        <div
            ...
            onClick={(e) => {
                console.log("LoginModal background clicked");
        ...
        >
            ...
            >
                ...
                <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Login</h2>
                ...
                <div className="p-10 space-y-8">
                    <div className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl py-5 pl-14 pr-14 text-sm font-bold outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all"
                            />
                            <button
                    ...
                    <div className="flex items-center justify-between px-2">
                        <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-colors">Forgot your password?</Link>
                    </div>

                    <button className="w-full bg-slate-950 dark:bg-blue-600 text-white rounded-2xl py-5 flex items-center justify-center gap-3 font-black uppercase tracking-[0.2em] text-xs hover:bg-blue-700 hover:shadow-2xl hover:shadow-blue-500/20 active:scale-[0.98] transition-all shadow-xl">
